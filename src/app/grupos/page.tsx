...
export default function GruposPage() {
 ...
 const openEdit = (g: any) => {
   router.push(`/grupos/novo?groupId=${g.id}`)
 }

  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-bold tracking-tight">Grupos de Importação</h2>
        <Button onClick={() => router.push("/grupos/novo")} className="gap-2">
